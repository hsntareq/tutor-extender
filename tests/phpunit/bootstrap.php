...
if ( ! defined( 'PERISCOPE_ABSPATH' ) ) {
	define( 'PERISCOPE_ABSPATH', sys_get_temp_dir() . '/wp-content/plugins/tutor-periscope/' );
}

require_once __DIR__ . '/../../vendor/autoload.php';

// Include the class for PluginTestCase
require_once __DIR__ . '/inc/PeriscopeTestCase.php';
